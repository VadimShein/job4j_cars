    ...
    <div class="row">
        <div class="card" style="width: 100%">
            ...
            <div class="card-body" style="display: inline">
                <div class="form-group" style="float: left">
                    <form action="<c:url value="item.do?action=edit&itemId=${param.itemId}"/>" method="post">
                        ...
                        <div id="model">
                            ...
                            <input type="text" class="form-control" name="model" title="Заполните поле: модель">
                        </div>
                        <div id="bodyType">
                ...
                <div class="form-group" style="float: left">
                    <form action="<c:url value="item.do?action=close&itemId=${param.itemId}"/>" method="post">
                        <input id="act" type="hidden" name="isActive">
                        <button id="actBtn" type="submit" class="btn btn-primary" style="width: 200px"></button>
                    </form>
                </div>
            </div>
        </div>
